...
function IdeaDetailPage() {
	...
	const { data: task, isLoading } = useTask(ideaId);
			...
			<div className="relative space-y-6">
				<StaggerReveal visible={isLoaded} delayMs={20}>
					<nav className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/85 px-3 py-1.5 text-xs text-slate-600 shadow-sm backdrop-blur">
						<Link to="/ideas" className="font-medium hover:text-slate-900">
							Ideas
						</Link>
								...
								<div className="min-w-0 flex-1">
									...
									<h1 className="text-3xl font-semibold tracking-tight wrap-break-word text-slate-950 sm:text-4xl">
										<span className="inline-flex items-center gap-2">
											...
											<HelpTooltip
												feature="Idea Detail"
												what="Full context for one idea."
												use="Review metadata, refine the idea, and promote it when ready."
												works="Combines idea data, subtasks, state history, and actions in one view."
											/>
										</span>
									</h1>
									...
									{task.state === "Ready" && (
										<div className="flex items-center gap-1.5">
											...
											<HelpTooltip
												...
												what="Begins a focus session on this idea."
												use="Use when you want focused time to refine or validate the idea."
												works="Creates an active timer session linked to this idea id."
											/>
										</div>
									)}
									<DropdownMenu>
							...
							<Card className="border-white/80 bg-white/95 shadow-sm">
								<CardHeader>
									<CardTitle className="inline-flex items-center gap-2 text-base">
										...
										<HelpTooltip
											feature="Snapshot"
											what="At-a-glance metadata summary for this idea."
											use="Use this panel to confirm size, urgency, and tracking fields."
											works="Reads normalized idea fields and derived labels from constants."
										/>
									</CardTitle>
								</CardHeader>
								...
								<CardHeader>
									<CardTitle className="inline-flex items-center gap-2 text-base">
										...
										<HelpTooltip
											...
											what="Chronological log of idea state transitions."
